...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.create = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userModel.findOne({ email: dto.email }).exec()];
                        case 1:
                            existing = _a.sent();
                            if (existing) {
                        ...
                        case 2:
                            hashed = _a.sent();
                            user = new this.userModel(__assign(__assign({}, dto), { password: hashed }));
        ...
        UsersService_1.prototype.markEmailVerified = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UsersService_1.prototype.getSummary = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, total, verified, latestUser;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a = _b.sent(), total = _a[0], verified = _a[1], latestUser = _a[2];
                            return [2 /*return*/, {
                                    total: total,
                                    verified: verified,
        ...
        UsersService_1.prototype.findPaginated = function (page, limit) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, { data: data, total: total, page: page, lastPage: Math.ceil(total / limit) }];
                    }
                });
            });
        };
         ...
         */
        UsersService_1.prototype.bulkInsert = function (users) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userModel.insertMany(users, { ordered: false }).catch(function (err) {
        ...
        UsersService_1.prototype.findUsersByIds = function (ids) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.userModel.find({ _id: { $in: ids } }).exec()];
                });
            });
        };
